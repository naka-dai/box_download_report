...
'''
    ...
    <div id="monthModal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h2 id="modalTitle">月別ダウンロード詳細</h2>
    ...
    <script>
        ...
        function showMonthDetails(month) {{
            ...
            modalTitle.textContent = `${{month}} ダウンロード詳細 (${{details.length}}件)`;
                ...
                <table class="detail-table">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 150px;">ダウンロード日時</th>
                        </tr>
                    </thead>
                    <tbody>
            `;
    ...
    <script>
        ...
        document.querySelectorAll('.user-count').forEach(element => {{
            element.addEventListener('mouseenter', (e) => {{
                ...
                tooltip.innerHTML = '<strong>ダウンロードユーザー:</strong><br>' + users.join('<br>');
